...
roc(train_y_es_1,train_x_es_1,
    ...
    lwd=4)
par(pty="s")
points(x=1-0.05932203,y=0.9565217, pch=19,cex=2,
             col="blue")
...
roc(train_y_pr,train_x_pr,
    ...
    lwd=4)
par(pty="s")
points(x=1-0.2582418,y=0.9513514, pch=19,cex=2,
       col="blue")
...
roc(train_y_her,train_x_her,
    ...
    lwd=4)
par(pty="s")
points(x=1-0.8183857,y=	0.9572650, pch=19,cex=2,
       col="blue")
